...
impl Transport {
    ...
    /// Send the given request to the Podman daemon and return a Future of the response.
    ...
    /// Podman container logs interactively.
    ...
    /// contains a Podman JSON error structure.
