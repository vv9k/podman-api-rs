...
public class PodmanApiCodegen extends DefaultCodegenConfig {

  static Logger LOGGER = LoggerFactory.getLogger(PodmanApiCodegen.class);

  static Map<String, String> SPECIAL_TYPES = new HashMap<String, String>() {
    {
      put("InlineResponse2001", "DockerImageBuildResponse");
      put("InlineResponse2003", "LibpodPodTopResponse");
      put("InlineResponse2008", "LibpodImageInspectResponse");
      put("InlineResponse2009", "LibpodImageSearchResponse");
      put("InlineResponse20010", "LibpodImageBuildResponse");
      put("InlineResponse20011", "LibpodContainerHealthcheckResponse");
      put("InlineResponse20012", "LibpodContainerInspectResponse");
      put("InlineResponse20013", "LibpodContainerStats");
      put("InlineResponse20014", "DockerImageInspectResponse");
      put("InlineResponse20015", "LibpodImageTreeResponse");
      put("InlineResponse20016", "LibpodPodInspectResponse");
      put("InlineResponse20017", "LibpodDataUsageResponse");
      put("InlineResponse20018", "LibpodSystemPruneResponse");
      put("InlineResponse20019", "LibpodVersionResponse");
      put("InlineResponse20020", "LibpodVolumeInspectResponse");
      put("InlineResponse20021", "LibpodNetworkCreateResponse");
      put("InlineResponse20022", "LibpodNetworksPruneResponse");
      put("InlineResponse20023", "LibpodVolumeListResponse");
      put("InlineResponse20024", "DockerVolumeInfoResponse");
      put("InlineResponse20025", "DockerVolumePruneResponse");
  ...
  public String getName() {
    return "podman-api-codegen";
  }

  public String getHelp() {
    return "Generates libpod API stubs";
  }
